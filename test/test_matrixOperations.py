import sys
#To use the matrixOperations.py in this file, you have to create a new environment variable as 
# PYTHONPATH = 'path of folder containing matrixOperations.py' 
import unittest
...
class testMatrixOperations(unittest.TestCase):
    ...
    def test_transpose(self):
        transpose = matrixOperations.transpose([[2, 5, 3], [4, 7, 6],[3, 8, 4]])
    ...
    def test_mult(self):
        mult = matrixOperations.mult([[2, 5, 3], [4, 7, 6],[3, 8, 4]],[[2, 4, 3], [5, 7, 8], [3, 6, 4]])
